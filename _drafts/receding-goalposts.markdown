...
— Disability does its best work as a stress test for naturalized presumptions of modernity. What is human needfulness, at the site of the body and as a guaranteed feature of any person's life-in-time? As Wendell Berry said long ago: The future will be divided between people who want to live as creatures and people who want to live as machines. We can help our students see both the goods of adaptive and inclusive design and the larger project of understanding and cultivating the common good. If you really want to help course-correct alongside the next generation, you might start by teaching chapter 2, "An Anthropological Approach," in Carter Snead's *What It Means to Be Human.* Bellah, Taylor, 
